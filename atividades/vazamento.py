...
usuario_principal = Usuario("Isis", "@Isis")
usuario_secundario = Usuario("monica", "@monica")

minha_rede_social = RedeSocial()

minha_rede_social.criar_post("Olá, eu sou a Isis!!", usuario_principal)
minha_rede_social.criar_post("Seja bem-vinda!", usuario_secundario)
minha_rede_social.criar_post("Alguém viu meu carregador???", usuario_principal)
minha_rede_social.criar_post("ESegunda-feira chegando...", usuario_secundario)

print("\n--- TESTANDO SEU CÓDIGO ---")
minha_rede_social.ver_meu_perfil(usuario_principal)
minha_rede_social.ver_meu_perfil(usuario_secundario)